...
# -*- coding: utf-8 -*-
"""
해커톤 2025 완전한 AI 투자교육 플랫폼 실행 스크립트
카카오페이증권 UI + 실제 데이터 + MBTI 추천 + AI 에이전트 통합 서비스
"""
...
def print_banner():
    """시작 배너 출력"""
    print("🎉" + "="*60)
    print("🏦 카카오페이증권 AI 투자교육 플랫폼")
    print("🎯 해커톤 2025 - 완전한 서비스")
    print("="*60)
    print("✨ 기능:")
    print("   📊 실제 증권 데이터 기반 사용자 분석")
    print("   🎯 AI 기반 투자 MBTI 추천")
    print("   🤖 6가지 투자 성향별 AI 에이전트")
    print("   💬 실시간 AI 채팅 상담")
    print("   🎨 카카오페이증권 스타일 UI")
    print("="*60)
...
def check_dependencies():
    ...
    required_files = [
        ...
        'hackathon_2025_complete_app.html',
        'kakao_securities_ui.css'
    ]
...
def open_web_app():
    ...
    html_file = os.path.abspath('hackathon_2025_complete_app.html')
...
def print_usage_guide():
    """사용 가이드 출력"""
    print("\n" + "="*60)
    print("🎉 해커톤 2025 AI 투자교육 플랫폼이 준비되었습니다!")
    print("="*60)
    print("📋 사용 방법:")
    ...
    print("   - 🤖 AI 에이전트: 투자 성향별 AI 선택")
    print("4. 💬 AI 채팅 버튼을 클릭하여 AI와 대화하세요")
    print("5. 🌙 다크 모드 토글을 사용하여 테마를 변경하세요")
    print("\n🔗 접속 정보:")
